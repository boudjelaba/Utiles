...
<head>
	...
	<meta http-equiv="refresh" content="8;URL= images.php">
	<title>Accueil</title>
	<style>
		.cat {
		  position: relative;
		...
		*, *:before, *:after {
		...
		body {
		  ...
		  min-height: 100%;
		  background-color: #161616;/*#f5f6f9;*/
		}
		...
		.logo-container:before {
		  ...
		  width: 100%;
		  height: 5px;
		  background-color: rgb(0,68,88);/*#cf0000;*/
		  transform-origin: center center;
		  transform: scaleX(0);
		  -webkit-animation: line-animation 4s ease infinite alternate;
		          animation: line-animation 4s ease infinite alternate;
		}
		.logo-container h1#page-logo {
		  font: bold 5rem "Arial", sans-serif;
		  -webkit-animation: clip-path-reveal-1 4s ease infinite alternate;
